...
def create_distill_mcp_server(conn: sqlite3.Connection) -> FastMCP:
    ...
    def get_episode_frames(episode_id: int, limit: int = 10) -> str:
        ...
        result = repo.get_episode_frames(conn, episode_id, limit)
    ...
    def get_playbook_history(name: str) -> str:
        ...
        result = repo.get_playbook_history(conn, name)
    ...
    def write_playbook_entry(
        ...
        log_tool_call(conn, STAGE, "write_playbook_entry", {"name": name, "confidence": confidence}, result)
